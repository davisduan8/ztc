...
<div class="h_y_name">
	<li>学术专长：</li>
	<li><?php echo $form->textField($expert,'skilled'); ?></li>
...
<div class="h_y_botton"><?php  echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => 'index.php?r=expert/exdzl&id='.$userid)); ?></div>
