...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#68AD5C">
  ...
  <tr>
    <td height="35" bgcolor="#FFFFFF"><a href="<?php echo Consultation::model()->getUrl(Yii::app()->user->id,strtotime($model['creattime']).$model['id'],Yii::app()->user->username,Yii::app()->user->role);?>" target="_blank">开始会诊</a>　　　　<span>查看DICOM影像：
<?php
