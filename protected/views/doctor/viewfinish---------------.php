...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#68AD5C">
  <tr>
    ...
    <td width="200" bgcolor="#FFFFFF"><?php  echo $model['hospitalid']==null? "":$model->hospital->h_name;//echo $model['hospitalid'];?></td>
    <td width="90" bgcolor="#D2D2D2">会诊专家：</td>
    <td bgcolor="#FFFFFF"><?php echo $model->expert->ename;//echo $model['expertid'];?></td>
...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#68AD5C">
  ...
  <tr>
    <td height="35" bgcolor="#D2D2D2">会诊意见:</td>
  </tr>
  <tr>
    <td height="35" bgcolor="#FFFFFF"><?php echo $model['ex_say'];?></td>
  </tr>
</table>
