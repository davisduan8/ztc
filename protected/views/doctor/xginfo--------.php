...
<div class="h_y_name">
	<li>申请医院：</li>
	<li><?php echo $form->textField($doctor,'hospital'); ?></li>
	<li><?php echo $form->error($doctor,'hospital'); ?></li>
</div>
<div class="clear"></div>
...
<div class="h_y_botton"><?php  echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => 'index.php?r=doctor/xginfo&id='.$userid)); ?></div>
