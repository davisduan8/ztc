...
<div class="h_y_botton">
    ...
    <button type="button" onclick="GetBox();" style="width:76px">下一步</button>
    
</div>

<div><a href="index.php?r=doctor/seccessadd&cid=<?=$_GET['cid']?>">不选专家直接下一步</a></div>
<script>
    function GetBox(){
        var opt = document.getElementsByName('selectdel');
        var  linkStr = "<?php echo Yii::app()->request->hostInfo.Yii::app()->urlManager->createUrl('doctor/zjgx&cid='.$_GET['cid']);?>"; //提交URL,自己改造
