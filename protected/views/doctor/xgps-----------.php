...
<table class="table6" width="0" border="0">
  ...
  <tr>
    ...
    <td>
    <input type='text' name='username' class='inp2' value="<?php echo  Yii::app()->user->username;?>" readonly="readonly"/>
    </td>
  ...
  <tr>
    ...
    <td width="292">
       <input type='password' name='nps' id='xm' class='inp2'/>
    </td>
  ...
  <tr>
    <td align="right" valign="middle">确认密码：</td>
        <td>
            <input type='password' name='rps' id='rm' class='inp2'/>
        </td>
