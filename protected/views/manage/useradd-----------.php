...
<dl class="h_flm">
	<dt>用户增加</dt>
	<dt><a href="index.php?r=manage/user">用户列表</a></dt>
</dl>
...
<div class="h_y_name">
	<li>用 户 组：</li>
	<li><?php echo $form->dropDownlist($users,'role',$htmlOptions=array('3'=>'管理员','99'=>'账户超管'),
	array('empty'=>'-请选择-')	); 	?></li>
	<li><?php echo $form->error($users,'role'); ?></li>
</div>
<div class="clear"></div>
<?php if ($where !== "edit"){?>
<div class="h_y_botton"><?php echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => 'index.php?r=manage/useradd'));; ?></div>
<?php
}else{
	?>
<div class="h_y_botton"><?php echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => "index.php?r=manage/userupdate&id={$users->id}"));; ?></div>
<?php
}
?>
