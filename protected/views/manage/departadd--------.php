...
<dl class="h_flm">
	<dt><a href="index.php?r=manage/depart">科室列表</a></dt>
	<dt>增加科室</dt>
</dl>
...
<div class="h_y_botton"><?php echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => 'index.php?r=manage/departadd'));; ?></div>
