...
<div class="clearfix part1">
	<p>
		<a href="index.php?r=admin/depart" class="btn1">科室列表</a>
...
<div class="form1 mt20">
	...
	<div class="tj_btn tj_btn2"><?php echo $form->hiddenField($depart,'siteid',array('value'=>Yii::app()->user->siteid));?><?php echo CHtml::imageButton(Yii::app()->baseUrl.'/img/tj_031.jpg',array('submit' => 'index.php?r=admin/departadd'));; ?></div>
</div>
