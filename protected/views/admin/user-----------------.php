...
.grid-view table.items #yw0_c0{width:50px;}
.grid-view table.items #yw0_c1{width:100px;}
.grid-view table.items #yw0_c2{width:80px;}
.grid-view table.items #yw0_c3{width:150px;}
.grid-view table.items #yw0_c4{width:100px;}
.grid-view table.items #yw0_c5{width:60px;}
</style>
<dl class="h_flm">
	<dt>用户列表</dt>
	<dt><a href="index.php?r=admin/useradd">用户增加</a></dt>
</dl>
