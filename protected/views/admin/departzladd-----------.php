...
<dl class="h_flm">
	<dt><a href="index.php?r=admin/departzl">问诊科室</a></dt>
	<dt>增加所需资料</dt>
</dl>
...
<div class="h_y_botton"><?php echo $form->hiddenField($departzl,'siteid',array('value'=>Yii::app()->user->siteid));?><?php echo CHtml::imageButton(Yii::app()->baseUrl.'/images/tijao.gif',array('submit' => 'index.php?r=admin/departzladd'));; ?></div>
