...
<div class="clearfix part1">
	<p>
		<label class="btn2 btn_cur">完善专家资料</label>
	</p>
</div>
...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <div class="clearfix form_box">
    <label>真实姓名：</label>
    <?php echo $form->textField($expert,'ename',array('class'=>'form_txt1')); ?>
  </div>
  <div class="clearfix form_box">
    <label>性　　别：</label>
  ...
  <div class="clearfix form_box">
    <label>擅　　长：</label>
    <?php echo $form->textArea($expert,'skilled',array('class'=>'form_txt10301')); ?>
  </div>

  <div class="clearfix form_box">
    <label>简　　介：</label>
    <?php echo $form->textArea($expert,'intro',array('class'=>'form_txt10301')); ?>
  </div>


<div class="tj_btn tj_btn2"><?php echo $form->hiddenField($expert,'userid',$htmlOptions=array('value'=>$userid));?> <?php echo CHtml::imageButton(Yii::app()->baseUrl.'/img/tj_031.jpg',array('submit' => 'index.php?r=admin/userdetail_2&id='.$userid));; ?></div>
